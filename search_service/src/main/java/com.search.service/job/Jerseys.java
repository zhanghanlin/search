...
public class Jerseys {
     ...
     */
    public static WebApplicationException buildException(Response.Status status,
                                                         String message) {
    ...
    public static Response buildTextResponse(Response.Status status, String message) {
